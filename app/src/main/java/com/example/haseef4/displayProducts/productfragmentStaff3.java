...
public class productfragmentStaff3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_productfragment_staff3, container, false);
        productList = (ListView) view.findViewById(R.id.chocolate_view2);
